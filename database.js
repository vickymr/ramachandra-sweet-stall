...
async function initDb() {
  ...
  const seedProducts = [
    {key:'boondhiLaddu',cid:sw,en:'Boondhi Laddu',ta:'பூந்தி லட்டு',img:'assets/laddu.jpeg',so:1,sz:sizes3(75,150,300)},
    {key:'badusha',cid:sw,en:'Badusha',ta:'பாதுஷா',img:'assets/Badusha.jpeg',so:2,sz:sizes3(75,150,300)},
    {key:'mysorePak',cid:sw,en:'Mysore Pak',ta:'மைசூர் பாக்',img:'assets/Mysore Pak.jpeg',so:3,sz:sizes3(75,150,300)},
    {key:'mixedSweetBox',cid:sw,en:'Mixed Sweet Box',ta:'மிக்ஸட் ஸ்வீட் பாக்ஸ்',img:'assets/no-image.svg',so:4,sz:[{n:'500 g',nt:'500 கிராம்',p:170},{n:'1 kg',nt:'1 கிலோ',p:340}]},
    {key:'whiteBurfi',cid:sw,en:'White Burfi',ta:'வெள்ளை பர்ஃபி',img:'assets/no-image.svg',so:5,sz:sizes3(100,200,400)},
    {key:'chocolateBurfi',cid:sw,en:'Chocolate Burfi',ta:'சாக்லேட் பர்ஃபி',img:'assets/no-image.svg',so:6,sz:sizes3(100,200,400)},
    {key:'roseBurfi',cid:sw,en:'Rose Burfi',ta:'ரோஸ் பர்ஃபி',img:'assets/no-image.svg',so:7,sz:sizes3(100,200,400)},
    {key:'fruitHalwa',cid:sw,en:'Fruit Halwa',ta:'புரூட் அல்வா',img:'assets/no-image.svg',so:8,sz:sizes3(100,200,400)},
    {key:'motiLaddu',cid:sw,en:'Moti Laddu',ta:'மோதி லட்டு',img:'assets/no-image.svg',so:9,sz:sizes3(100,200,400)},
    {key:'motiPak',cid:sw,en:'Moti Pak',ta:'மோதி பாக்',img:'assets/no-image.svg',so:10,sz:sizes3(100,200,400)},
    {key:'cashewnutHalwa',cid:sw,en:'Cashewnut Halwa',ta:'முந்திரி அல்வா',img:'assets/no-image.svg',so:11,sz:sizes3(120,240,480)},
    {key:'soanPapdi',cid:sw,en:'Soan Papdi',ta:'சோன் பப்டி',img:'assets/no-image.svg',so:12,sz:sizes3(120,240,480)},
    {key:'specialMysorePak',cid:sw,en:'Ghee Mysore Pak',ta:'நெய் மைசூர் பாக்',img:'assets/no-image.svg',so:13,sz:sizes3(120,240,480)},
    {key:'palkova',cid:sw,en:'Palkova',ta:'பால்கோவா',img:'assets/no-image.svg',so:14,sz:sizes3(120,240,480)},
    {key:'milkCake',cid:sw,en:'Milk Cake',ta:'மில்க் கேக்',img:'assets/no-image.svg',so:15,sz:sizes3(120,240,480)},
    {key:'kajuKatli',cid:sw,en:'Kaju Katli',ta:'காஜு கத்லி',img:'assets/no-image.svg',so:16,sz:sizes3(225,450,900)},
    {key:'butterMurukku',cid:sa,en:'Butter Murukku',ta:'வெண்ணெய் முறுக்கு',img:'assets/no-image.svg',so:1,sz:sizes3(75,150,300)},
    {key:'mixture',cid:sa,en:'Mixture',ta:'மிக்சர்',img:'assets/no-image.svg',so:2,sz:sizes3(75,150,300)},
    {key:'motaMixture',cid:sa,en:'Mota Mixture',ta:'தடித்த மிக்சர்',img:'assets/no-image.svg',so:3,sz:sizes3(75,150,300)},
    {key:'ribbonMurukku',cid:sa,en:'Ribbon Murukku',ta:'ரிப்பன் முறுக்கு',img:'assets/no-image.svg',so:4,sz:sizes3(75,150,300)},
    {key:'karaSev',cid:sa,en:'Kara Sev',ta:'கார சேவ்',img:'assets/no-image.svg',so:5,sz:sizes3(75,150,300)},
    {key:'karaBoondhi',cid:sa,en:'Kara Boondhi',ta:'கார பூந்தி',img:'assets/no-image.svg',so:6,sz:sizes3(75,150,300)},
    {key:'onionPakoda',cid:sa,en:'Onion Pakoda',ta:'வெங்காய பக்கோடா',img:'assets/no-image.svg',so:7,sz:sizes3(75,150,300)},
    {key:'garlicSev',cid:sa,en:'Garlic Sev',ta:'பூண்டு சேவ்',img:'assets/no-image.svg',so:8,sz:sizes3(75,150,300)},
    {key:'kadalaPakoda',cid:sa,en:'Kadala Pakoda',ta:'கடலை பக்கோடா',img:'assets/no-image.svg',so:9,sz:sizes3(75,150,300)},
    {key:'splMixture',cid:sa,en:'SPL Mixture',ta:'ஸ்பெஷல் மிக்சர்',img:'assets/no-image.svg',so:10,sz:[{n:'250 g',nt:'250 கிராம்',p:85},{n:'500 g',nt:'500 கிராம்',p:170},{n:'1 kg',nt:'1 கிலோ',p:340}]},
    {key:'potatoChips',cid:sa,en:'Potato Chips',ta:'உருளைக்கிழங்கு சிப்ஸ்',img:'assets/no-image.svg',so:11,sz:sizes3(100,200,400)},
    {key:'bananaChips',cid:sa,en:'Banana Chips',ta:'வாழைக்காய் சிப்ஸ்',img:'assets/no-image.svg',so:12,sz:sizes3(100,200,400)},
  ];

  for (const p of seedProducts) {
    if (!await db.get('SELECT id FROM products WHERE key = ?', [p.key])) {
      const r = await db.run('INSERT INTO products (key, category_id, name_en, name_ta, image, sort_order) VALUES (?, ?, ?, ?, ?, ?)',
        [p.key, p.cid, p.en, p.ta, p.img, p.so]);
